...
**NOTE:** *The **[-Timer]** boolean parameter by default is set to $true and will render the time it took to process the function or script path executed. This can be disabled by adding **[-Timer $false]** when executing the Show-Treemenu function*
